...
var setSearchResult = function setSearchResult(Criteria) {
...
var getCategory = function getCategory(Gender) {

    var url = '/api/CategoryApi/Get?Gender=' + Gender;
...
var SearchProduct = function SearchProduct(Criteria) {

    var url = '/api/ProductApi/Search';
...
//建立分類
var setCategory = function setCategory(data, Gender) {
...
//分類初始化
var categoryLoad = function categoryLoad(Gender) {

    var data = getCategory(Gender);
};

//顯示女裝
var showWomen = function showWomen() {
